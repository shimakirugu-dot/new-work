...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [453672.248300, 4701954.644200, 482877.782800, 4738114.620200], maxZoom: 10, minZoom: 6, projection: new ol.proj.Projection({
            code: 'USER:100000',
            //extent: [453672.248300, 4701954.644200, 482877.782800, 4738114.620200],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([453672.248300, 4701954.644200, 482877.782800, 4738114.620200], map.getSize());
